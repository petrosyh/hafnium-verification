...
pte_t arch_mm_absent_pte(uint8_t level)
{
  ...
  Definition arch_mm_absent_pte (level:var) : stmt := Return (repr 0).
...
uint8_t arch_mm_stage1_max_level(void)
{
   ...
   *)
  Definition arch_mm_stage1_max_level := Return (repr 2).
...
uint8_t arch_mm_stage1_root_table_count(void)
{
   ...
   *)
  Definition arch_mm_stage1_root_table_count := Return (repr 1).
