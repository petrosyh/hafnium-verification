...
// JIEUNG
// STAGE1 - present / absent 
// STAGE2 - valid / invalid, owned / unowned, exclusive / shared
...
// JIEUNG: This will not be parts of our modeling, but we need to use following
...
bool arch_mm_init(paddr_t table)
{
	...
	static const int pa_bits_table[16] = {32, 36, 40, 42, 44, 48};
        // JIEUNG: This is how we define pa_bits for levels
...
*/
        ...
        // JIEUNG: This is how we define table counters 
