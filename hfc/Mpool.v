...
Module MPOOLCONCUR.
  ...
  *)
  ...
  Definition mpool_alloc_contiguous_no_fallback
    ...
    (Call "MPOOL.mpool_unlock" [CBR p]) #;
    Put "new_chunk @ limit" (new_chunk #@ limit_loc) #;
    Put "new_chunk @ next_chunk_loc" (new_chunk #@ next_chunk_loc) #;
    Put "new_chunk" new_chunk #;
    Put "RET final: " ret #;
    (* Put "-----------------------------------" Vnull #; *)
    (* Put "p :" p#; *)
    (* Put "lock :" (p #@ lock_loc) #; *)
    (* Put "entry_size :" (p #@ entry_size_loc) #; *)
    (* Put "chunk_list :" (p #@ chunk_list_loc) #; *)
    (* Put "entry_list :" (p #@ entry_list_loc) #; *)
    (* Put "fall_back :" (p #@ fallback_loc) #; *)
    (* Put "-----------------------------------" Vnull #; *)
    Return ret.
